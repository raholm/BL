...
mixedg <- mixedgibbs(rainfall$V1, iter, init, hyperparams)
mixedsamples <- mixedg$params
samples <- mixedg$samples
```
...
plot(x = 1:iter, mixedsamples[, 5], type="l")
par(mfrow = c(1,1))
```
